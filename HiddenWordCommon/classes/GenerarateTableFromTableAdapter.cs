...
{
    class GenerarateTableFromTableAdapter
    {
        ...
        /// </summary>
        public static string BuildCreateTableScript(System.Data.DataTable Table)
        {
            ...
            bool FirstTime = true;
            foreach (System.Data.DataColumn column in Table.Columns.OfType<System.Data.DataColumn>())
            {
        ...
        /// </summary>
        private static string BuildKeysScript(System.Data.DataTable Table)
        {
            ...
            {
                List<string> compositeKeys = Table.PrimaryKey.OfType<System.Data.DataColumn>().Select(dc => dc.ColumnName).ToList();
